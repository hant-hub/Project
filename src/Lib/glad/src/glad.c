/*
    ...
    OpenGL loader generated by glad 0.1.34 on Wed Jul 26 23:47:51 2023.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.6" --generator="c" --spec="gl" --extensions="GL_ARB_get_program_binary,GL_ARB_gl_spirv"
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D4.6&extensions=GL_ARB_get_program_binary&extensions=GL_ARB_gl_spirv
*/
